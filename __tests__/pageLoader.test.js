...
describe('page loader', () => {
  test('test', async () => {
    const expected = '<html><head></head><body>test data</body></html>';
    const testPath = '/test';
  ...
  test('another test', async () => {
    const expected = '<html><head></head><body>another test data</body></html>';
    ...
    const link = host.concat(testPath);
    const filename = 'test-com-anothertest.html';
    const dest = path.join(tempDir, filename);
